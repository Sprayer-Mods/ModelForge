...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        model = YoloModel(cfg or ckpt['model'].yaml, ch=3, nc=nc, anchors=hyp.get('anchors')).to(device)  # create
        ...
        model = YoloModel(cfg, ch=3, nc=nc, anchors=hyp.get('anchors')).to(device)  # create
