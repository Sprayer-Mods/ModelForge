...
from models.sm_common import *
from models.experimental import *
from models.yolox import YOLOXHead
...
# This is just so I can have something hanging around
...
class Model(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, Detect) or isinstance(m, IDetect): #maybe add in IDetect here...
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    try:
        ...
        nl, nc, gd, gw = d['nl'], d['nc'], d['depth_multiple'], d['width_multiple']
        na = 0              # yolox (and some other models) use no anchors
        no = nc + 5         # number of outputs with no anchors
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, 
                 ...
                 DWConvTranspose2d, C3x, TConv,
                 TDWConv, TC3, TBottleneck, TSMResBlock, SPPCSPC, RepConv):
            c1, c2 = ch[f], args[0]
