...
# ModelForge by Spryaer Mods, GPL-3.0 license
"""
Video object detection modules

This is different from normal dectection, as the model will be 

Usage:
    $ python path/to/models/video.py --cfg path/to/cfgs/video.yaml
